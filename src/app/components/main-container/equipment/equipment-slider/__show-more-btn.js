...
const brandsCollapse = document.querySelector(".equipment-slider--collapsed");
...
showMoreBtn.addEventListener("click", () => {
  ...
  brandsCollapse.classList.toggle("equipment-slider--collapsed");
  brandsCollapse.classList.toggle("equipment-slider--expanded");
